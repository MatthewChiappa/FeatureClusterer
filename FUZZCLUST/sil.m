function [s,h] = sil(X, clust, distance, varargin)
...
%   $Revision: 1.1.8.1 $ $Date: 2010/03/16 00:17:31 $
    ...
    case 'function'
        try
            ...
            if isa(distance,'inline')
                throw(addCause(MException('stats:silhouette:DistanceFunctionError',...
            ...
            elseif strcmp('MATLAB:UndefinedFunction', ME.identifier) ...
                ...
                throw(addCause(MException('stats:silhouette:DistanceFunctionError',...
                      'Error evaluating the distance function ''%s''.', ...
                      func2str(distance)),...
                               ME));
            end
        end
...
if (nargout == 0) || (nargout > 1)
    ...
    ylabel('Cluster');
    title('Silhouette with Cosine Distance')
end
